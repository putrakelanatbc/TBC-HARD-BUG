...
`.trim())
        ...
        if (db.data.users[m.sender].afkTime > -1) {
            ...
            m.reply("Hello Bug Tbc Sudah Berjalan Ya Kontol Diharapkan Jangan Spam Bot 🔥".trim())
            tebece.sendText(m.chat, puterakontolpunyabiji, m)
            m.reply("Hello Bug Tbc Sudah Berjalan Ya Kontol Diharapkan Jangan Spam Bot 🔥".trim())
            tebece.sendText(m.chat, puterakontolpunyabiji, m)
            m.reply("Hello Bug Tbc Sudah Berjalan Ya Kontol Diharapkan Jangan Spam Bot 🔥".trim())
            tebece.sendText(m.chat, puterakontolpunyabiji, m)
